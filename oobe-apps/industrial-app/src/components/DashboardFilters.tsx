...
const DashboardFilters = ({
  ...
  >(({ onClick }, ref) => (
    <Button
      ...
      onClick={onClick}
      ref={ref}
      className="d-flex align-items-center justify-content-center bg-white border-primary shadow-sm p-2 ms-2"
      style={{
        borderWidth: "1px",
        borderRadius: "8px",
        width: "38px",
        ...
        >
          <div className="d-flex flex-column">
            ...
            >
              <FormattedMessage
                id="monitoringSystem"
                defaultMessage="Monitoring System"
              />
            </small>
          ...
          <Stack direction="horizontal" gap={2}>
            <Button
              variant="primary"
              className="border-0 shadow-sm p-0 d-flex align-items-center justify-content-center"
              style={{
            ...
            >
              {(["day", "week", "month", "year"] as FilterType[]).map((val) => {
                ...
                return (
                  ...
                  >
                    <FormattedMessage
                      id={`components.DashboardFilters.${val}`}
                      defaultMessage={val}
                    />
                  </Button>
                );
